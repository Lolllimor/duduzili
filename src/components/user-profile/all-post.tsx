...
export const AllPosts = () => {
  return (
    <section className="bg-white px-6 flex flex-col gap-2">
      <div className="bg-red-500">
          ...
          <section className="flex items-start gap-5 py-5">
            ...
            <div>
              <h3 className="font-sora font-semibold text-base text-[#2A2A2A]">
                Babatunde Adekunle{" "}
                <span className="font-normal font-sora text-sm text-[#494850]">
                  {" "}
                  @adetunes{" "}
                </span>
              </h3>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-sora font-normal text-sm text-[#4534B8]">
              #wedding #design
            </p>
          </div>
        </div>
